...
public class OfficeDesk {
    public static void main(String[] args) throws IOException {
        // The URL of the office desk product page we want to extract data from
        ...
        for (Element productElement : productElements) {
            ...
            String productCategory = "Electronics > Computer Accesories > Furniture > Food and Breakroom";
